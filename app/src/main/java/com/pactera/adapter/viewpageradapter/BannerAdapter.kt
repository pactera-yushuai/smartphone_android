 ...
 */
class BannerAdapter(mDatas: List<Banner?>?) : BannerAdapter<Banner?, com.pactera.adapter.viewpageradapter.BannerAdapter.BannerViewHolder>(mDatas) {
...
//        holder?.imageView?.setImageResource(R.mipmap.shanping)
    ...
    public inner class BannerViewHolder(var imageView: ImageView) : RecyclerView.ViewHolder(imageView)
